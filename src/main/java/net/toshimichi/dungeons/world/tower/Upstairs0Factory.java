...
public class Upstairs0Factory extends SchematicRoomFactory implements Buildable {
    ...
    static {
        ...
        ranges.add(new Range(new Pos(1, 6, 2), new Pos(1, 8, 4)));
        gateways = Collections.unmodifiableList(ranges);
    }

    public Upstairs0Factory(NormalDungeon dungeon, Clipboard clipboard) {
    ...
    public EmptyRoom build(String id, Pos origin, Direction direction) {
